// Electricity data parsing utilities
...
export const parseElectricityData = (rawData: string) => {
...
export const initialElectricityData = parseElectricityData(rawElectricityDataString);
export const availableMonths = Object.keys(initialElectricityData[0].consumption);