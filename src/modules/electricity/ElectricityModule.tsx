...
import { LayoutDashboard, TrendingUp, BarChart2, List, Filter, CalendarDays, Sparkles, X, Zap, DollarSign, Users2 } from 'lucide-react';
import { electricityRawData } from '../../data/electricityData';
import { parseElectricityData } from '../../data/electricityParser';
...
const ElectricityModule: React.FC = () => {
  ...
  const initialElectricityData = useMemo(() => parseElectricityData(electricityRawData), []);
  ...
  }, [selectedCategory, initialElectricityData]);
