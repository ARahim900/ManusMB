...
import { WaterSubSection } from '../../types/navigation';
import { SummaryCard } from '../../components/ui/SummaryCard';
import { ChartWrapper } from '../../components/ui/ChartWrapper';
import { StyledSelect } from '../../components/ui/StyledSelect';
import { waterSystemData, waterMonthsAvailable } from '../../data/waterData';

export const WaterModule: React.FC = () => {
  const [isLoading, setIsLoading] = useState(false);
  const [selectedWaterMonth, setSelectedWaterMonth] = useState('Mar-25');
  const [activeWaterSubSection, setActiveWaterSubSection] = useState<WaterSubSection>('Overview');
  ...
  const WaterSubNav = () => {
    const subSections = [
      { name: 'Overview', id: 'Overview' as WaterSubSection, icon: LayoutDashboard },
      { name: 'Water Loss Analysis', id: 'WaterLoss' as WaterSubSection, icon: TrendingUp },
      { name: 'Zone Analysis', id: 'ZoneAnalysis' as WaterSubSection, icon: BarChart2 },
      { name: 'Quality Metrics', id: 'Quality' as WaterSubSection, icon: CheckCircle },
    ];
  ...
  const WaterFilterBar = () => {
    ...
    const zoneOptions = [
      ...
      ...distinctZones.map(z => ({ value: z, label: z })),
    ];
  ...
  return (
    <div className="space-y-6">
      <div className="text-center mb-8">
        <h1 className="text-3xl font-bold text-slate-800 mb-2">Water Analysis System</h1>
              ...
              <div className="p-4 bg-slate-50 rounded-lg">
                <div className="flex justify-between items-center mb-2">
                  ...
                  <span className="text-lg font-bold text-green-600">
                    {waterCalculations.systemEfficiency.toFixed(1)}%
                  </span>
                </div>
