...
import { Menu, Power, Zap, Droplets, Combine, UserCheck, DollarSign } from 'lucide-react';
import { COLORS, MAIN_SECTIONS } from '../utils/constants';
      ...
      <nav className="space-y-2">
        {MAIN_SECTIONS.map(section => {
          ...
          return (
            ...
            >
              <IconComponent size={22} className={`group-hover:scale-110 transition-transform text-white flex-shrink-0`} />
